...
def optimize():
    COMPOSITE =  5261470998603516916930006943408020218054465227008067938097596159451633967222320277954269752819219434142075078097031898141544200093216780618801
    GPU_CORES = 8192
    CPU_CORES = 16
    PARAMETER = 3
    STARTINGT = 45
